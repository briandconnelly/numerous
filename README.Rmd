...
we'll get the "Phase of the Moon" metric and plot its values.
...
*updated* is the name Numerous uses for the time at which a metric's value was
updated. Different labels and other properties can be specified using the
